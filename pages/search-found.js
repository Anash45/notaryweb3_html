                ...
                <div className="col-lg-9">
                  ...
                  <div className="border search-box">
                    <div className="top px-md-5 py-5">
                      <div className="px-sm-5 px-0">
                        <p className="search-subtitle">
                          You domain is available
                        </p>
                        <h3 className="search-domain">
                        ...
                        <div className="search-btns">
                          <a href="#" className="btn px-4 rounded-0 btn-golden">
                            Add to cart
                          </a>
                          <a href="#" className="btn px-4 rounded-0">
                            Favorite
                          </a>
                        </div>
                      </div>
                    ...
                    <div className="bottom px-md-5 py-5">
                      <div className="px-sm-5 px-0">
                        <p className="search-offer">Why not secure both ?</p>
                        <table>
                          <tbody>
                            <tr>
                              <td className="pr-3">[your name].notary</td>
                              <td>
                            ...
                            <tr>
                              <td className="pr-3">[your name].notarypublic</td>
                              <td>
                                <div className="form-check form-check-lg">
                                  <input
                                    className="form-check-input form-check-input"
